...
def draw_rectangle(frame):
    ...
    height, width, _ = frame_cv2.shape
    ...
    cv2.rectangle(frame_cv2, (x1, y1), (x2, y2), (0, 255, 0), 2)

    # Encode the frame back to JPEG format
    _, encoded_frame = cv2.imencode('.jpg', frame_cv2)
            ...
            try:
                while True:
                    with output.condition:
                        ...
                        frame = output.frame
                        processed_frame = draw_rectangle(frame)
